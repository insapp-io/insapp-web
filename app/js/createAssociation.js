app.controller('CreateAssociation', ['$scope', '$resource', 'Session', '$location', 'ngDialog', function($scope, $resource, Session, $location, ngDialog) {
  var Association = $resource('https://insapp.insa-rennes.fr/api/v1/association?token=:token')
  var User = $resource('https://insapp.insa-rennes.fr/api/v1/association/:id/user?token=:token')
